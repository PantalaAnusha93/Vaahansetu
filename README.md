...
**VaahanSetu** addresses these challenges by offering a unified platform where:
...
### 🎓 Developers (Team THE ORIGINAL GANGSTERS)
| Name | Register Number | Role / Contribution |
| :--- | :--- | :--- |
| **Pantala Anusha** | 99220041072 | Team Lead & Implementation |
| **Kotaru Chaitanya Lakshmi** | 99220040585 | Backend Logic & Integration |
| **Tera Navya Sri** | 99220040746 | Database Design & Management |
| **Yangareddy Charvitha** | 99220040783 | Frontend Development & UI/UX |

### 👨‍🏫 Project Supervisors & Coordinators
* **Project Supervisor:** Dr. P. Velmurugadass (Associate Professor, Dept. of CSE).
...
VaahanSetu follows a highly scalable **Three-Layer Architecture**:
